...
if [ ! -f "/isos/a.iso" ]; then
    wget -O /isos/a.iso https://computernewb.com/isos/windows/Win10_22H2_English_x64.iso
fi
if [ ! -f "/isos/driver.iso" ]; then
    wget -O /isos/driver.iso https://fedorapeople.org/groups/virt/virtio-win/direct-downloads/archive-virtio/virtio-win-0.1.240-1/virtio-win-0.1.240.iso
fi
